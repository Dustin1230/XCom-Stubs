...
simulated function AS_AddShip(int continentIndex, string shipName, string WeaponType, string Status, optional string Help, optional int State=0){}
simulated function AS_AddPendingShip(int continentIndex, string infoTxt, string statusTxt, optional string Help, optional int ShipType=1){}
...
simulated function AS_InitializeShipTransfer(optional string transferringShipTextOverride="undefined", optional string emptySlotTextOverride="undefined"){}
