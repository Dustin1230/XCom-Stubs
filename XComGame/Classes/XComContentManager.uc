...
final function RequestContentArchetype(EContentCategory ContentType, int Id, optional int SubID=-1, optional Object CallbackObject, optional delegate<OnArchetypeLoaded> Callback, optional bool bAsync=false){}
final function RequestContentArchetypeByTag(EContentCategory ContentType, name CustomTag, optional Object CallbackObject, optional delegate<OnArchetypeLoaded> Callback, optional bool bAsync=false){}
final function int GetContentIdFromTag(EContentCategory ContentType, const out name CustomTag){}
final function GetContentIdsForGender(EContentCategory ContentType, XGTacticalGameCoreNativeBase.EGender Gender, out array<int> Ids, optional bool bCivilianOnly=false, optional bool bAllowHelmets=false){}
final function GetContentIdsForCharacter(EContentCategory ContentType, XGGameData.ECharacter CharType, out array<int> Ids, optional bool bCivilianOnly=false, optional bool bAllowHelmets=false){}
final function GetContentIdsForRace(EContentCategory ContentType, XGTacticalGameCoreNativeBase.ECharacterRace Race, out array<int> Ids, optional bool bCivilianOnly=false, optional bool bAllowHelmets=false){}
final function GetContentIdsForPawn(EContentCategory ContentType, XGGameData.EPawnType PawnType, out array<int> Ids, optional bool bAllowHelmets=false){}
final function GetContentIdsForArmor(EContentCategory ContentType, XGGameData.EItemType ArmorType, out array<int> Ids, optional bool bGeneModOnly=false){}
